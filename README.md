...
![output 1](https://github.com/Agus-Iskandar-D/Green-Finance-Data-Analysis/blob/Bonus-Question-Sklearn/Asset/output%201.png)

💡 Analisis:

Projek PLTS memiliki efisiensi CO2 Reduction per unit investasi rendah (low)
...
Klik [di sini](https://github.com/Agus-Iskandar-D/Green-Finance-Data-Analysis/blob/Bonus-Question-Sklearn/README.md)
